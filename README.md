...
| <a name="input_cert_deploy"></a> [cert\_deploy](#input\_cert\_deploy) | n/a | `bool` | n/a | yes |
...
| <a name="input_vault_unseal_cron_schedule"></a> [vault\_unseal\_cron\_schedule](#input\_vault\_unseal\_cron\_schedule) | n/a | `string` | n/a | yes |
...
| <a name="input_cert_namespace"></a> [cert\_namespace](#input\_cert\_namespace) | n/a | `string` | `"cert-manager"` | no |
...
| <a name="input_grafana_loki_compatibility_image_tag"></a> [grafana\_loki\_compatibility\_image\_tag](#input\_grafana\_loki\_compatibility\_image\_tag) | n/a | `string` | `""` | no |
| <a name="input_keycloack_provisioner"></a> [keycloack\_provisioner](#input\_keycloack\_provisioner) | n/a | `string` | `""` | no |
...
| <a name="input_loki_provisioner"></a> [loki\_provisioner](#input\_loki\_provisioner) | Value for the provisioner key in the storage class. If in a bare metal environment and no provisioner available, set this to 'local-path' | `string` | `""` | no |
...
| <a name="input_nginx_helm_release_name"></a> [nginx\_helm\_release\_name](#input\_nginx\_helm\_release\_name) | n/a | `string` | `"ingress-nginx"` | no |
| <a name="input_nginx_helm_repo_url"></a> [nginx\_helm\_repo\_url](#input\_nginx\_helm\_repo\_url) | n/a | `string` | `"https://kubernetes.github.io/ingress-nginx"` | no |
| <a name="input_nginx_ingress_version"></a> [nginx\_ingress\_version](#input\_nginx\_ingress\_version) | n/a | `string` | `"4.10.1"` | no |
| <a name="input_nginx_namespace"></a> [nginx\_namespace](#input\_nginx\_namespace) | n/a | `string` | `"ingress-nginx"` | no |
...
| <a name="input_project_customer_name"></a> [project\_customer\_name](#input\_project\_customer\_name) | n/a | `string` | `"cosmotech"` | no |
| <a name="input_prom_admin_password"></a> [prom\_admin\_password](#input\_prom\_admin\_password) | n/a | `string` | `""` | no |
| <a name="input_prom_cpu_mem_limits"></a> [prom\_cpu\_mem\_limits](#input\_prom\_cpu\_mem\_limits) | n/a | `string` | `""` | no |
| <a name="input_prom_cpu_mem_request"></a> [prom\_cpu\_mem\_request](#input\_prom\_cpu\_mem\_request) | n/a | `string` | `""` | no |
...
| <a name="input_prom_redis_port"></a> [prom\_redis\_port](#input\_prom\_redis\_port) | n/a | `number` | `6379` | no |
...
| <a name="input_prom_stack_version"></a> [prom\_stack\_version](#input\_prom\_stack\_version) | n/a | `string` | `"57.1.0"` | no |
