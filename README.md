...
| <a name="input_prom_alert_manager_resources"></a> [prom\_alert\_manager\_resources](#input\_prom\_alert\_manager\_resources) | n/a | <pre>object({<br>    requests = object({<br>      cpu    = string<br>      memory = string<br>    })<br>    limits = object({<br>      cpu    = string<br>      memory = string<br>    })<br>  })</pre> | n/a | yes |
...
| <a name="input_prom_pv_existing_name"></a> [prom\_pv\_existing\_name](#input\_prom\_pv\_existing\_name) | n/a | `string` | n/a | yes |
...
| <a name="input_prom_resources"></a> [prom\_resources](#input\_prom\_resources) | n/a | <pre>object({<br>    requests = object({<br>      cpu    = string<br>      memory = string<br>    })<br>    limits = object({<br>      cpu    = string<br>      memory = string<br>    })<br>  })</pre> | n/a | yes |
...
| <a name="input_pvc_grafana_storage_accessmode"></a> [pvc\_grafana\_storage\_accessmode](#input\_pvc\_grafana\_storage\_accessmode) | n/a | `string` | n/a | yes |
| <a name="input_pvc_grafana_storage_class_name"></a> [pvc\_grafana\_storage\_class\_name](#input\_pvc\_grafana\_storage\_class\_name) | n/a | `string` | n/a | yes |
| <a name="input_pvc_grafana_storage_gbi"></a> [pvc\_grafana\_storage\_gbi](#input\_pvc\_grafana\_storage\_gbi) | n/a | `string` | n/a | yes |
| <a name="input_pvc_keycloak_postgres_deploy"></a> [pvc\_keycloak\_postgres\_deploy](#input\_pvc\_keycloak\_postgres\_deploy) | n/a | `bool` | n/a | yes |
| <a name="input_pvc_keycloak_postgres_storage_accessmode"></a> [pvc\_keycloak\_postgres\_storage\_accessmode](#input\_pvc\_keycloak\_postgres\_storage\_accessmode) | n/a | `string` | n/a | yes |
| <a name="input_pvc_keycloak_postgres_storage_class_name"></a> [pvc\_keycloak\_postgres\_storage\_class\_name](#input\_pvc\_keycloak\_postgres\_storage\_class\_name) | n/a | `string` | n/a | yes |
| <a name="input_pvc_keycloak_postgres_storage_gbi"></a> [pvc\_keycloak\_postgres\_storage\_gbi](#input\_pvc\_keycloak\_postgres\_storage\_gbi) | n/a | `string` | n/a | yes |
| <a name="input_pvc_loki_stack_deploy"></a> [pvc\_loki\_stack\_deploy](#input\_pvc\_loki\_stack\_deploy) | n/a | `bool` | n/a | yes |
| <a name="input_pvc_loki_stack_namespace"></a> [pvc\_loki\_stack\_namespace](#input\_pvc\_loki\_stack\_namespace) | n/a | `string` | n/a | yes |
| <a name="input_pvc_loki_storage_accessmode"></a> [pvc\_loki\_storage\_accessmode](#input\_pvc\_loki\_storage\_accessmode) | n/a | `string` | n/a | yes |
...
| <a name="input_storageclass_provisioner_azure_file"></a> [storageclass\_provisioner\_azure\_file](#input\_storageclass\_provisioner\_azure\_file) | n/a | `string` | n/a | yes |
...
| <a name="input_tekton_deploy"></a> [tekton\_deploy](#input\_tekton\_deploy) | n/a | `bool` | n/a | yes |
...
| <a name="input_vault_secrets_operator_organization"></a> [vault\_secrets\_operator\_organization](#input\_vault\_secrets\_operator\_organization) | n/a | `string` | n/a | yes |
